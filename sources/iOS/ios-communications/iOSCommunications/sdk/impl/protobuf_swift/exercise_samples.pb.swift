...
extension Data_PbPowerMeasurements: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularInt32Field(value: &self._currentPower)
      case 2: try decoder.decodeSingularUInt32Field(value: &self._cumulativeCrankRevolutions)
      case 3: try decoder.decodeSingularUInt32Field(value: &self._cumulativeTimestamp)
      case 4: try decoder.decodeSingularSInt32Field(value: &self._forceMagnitudeMin)
      case 5: try decoder.decodeSingularInt32Field(value: &self._forceMagnitudeMax)
      case 6: try decoder.decodeSingularUInt32Field(value: &self._forceMagnitudeMinAngle)
      case 7: try decoder.decodeSingularUInt32Field(value: &self._forceMagnitudeMaxAngle)
      case 8: try decoder.decodeSingularUInt32Field(value: &self._bottomDeadSpotAngle)
      case 9: try decoder.decodeSingularUInt32Field(value: &self._topDeadSpotAngle)
      case 10: try decoder.decodeSingularUInt32Field(value: &self._pedalPowerBalance)
      case 11: try decoder.decodeSingularInt32Field(value: &self._torqueMagnitudeMin)
      case 12: try decoder.decodeSingularInt32Field(value: &self._torqueMagnitudeMax)
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if let v = self._currentPower {
      try visitor.visitSingularInt32Field(value: v, fieldNumber: 1)
    }
    if let v = self._cumulativeCrankRevolutions {
      try visitor.visitSingularUInt32Field(value: v, fieldNumber: 2)
    }
    if let v = self._cumulativeTimestamp {
      try visitor.visitSingularUInt32Field(value: v, fieldNumber: 3)
    }
    if let v = self._forceMagnitudeMin {
      try visitor.visitSingularSInt32Field(value: v, fieldNumber: 4)
    }
    if let v = self._forceMagnitudeMax {
      try visitor.visitSingularInt32Field(value: v, fieldNumber: 5)
    }
    if let v = self._forceMagnitudeMinAngle {
      try visitor.visitSingularUInt32Field(value: v, fieldNumber: 6)
    }
    if let v = self._forceMagnitudeMaxAngle {
      try visitor.visitSingularUInt32Field(value: v, fieldNumber: 7)
    }
    if let v = self._bottomDeadSpotAngle {
      try visitor.visitSingularUInt32Field(value: v, fieldNumber: 8)
    }
    if let v = self._topDeadSpotAngle {
      try visitor.visitSingularUInt32Field(value: v, fieldNumber: 9)
    }
    if let v = self._pedalPowerBalance {
      try visitor.visitSingularUInt32Field(value: v, fieldNumber: 10)
    }
    if let v = self._torqueMagnitudeMin {
      try visitor.visitSingularInt32Field(value: v, fieldNumber: 11)
    }
    if let v = self._torqueMagnitudeMax {
...
extension Data_PbCalibrationValue: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try decoder.decodeSingularEnumField(value: &self._operation)
      case 4: try decoder.decodeSingularEnumField(value: &self._cause)
      default: break
      }
    }
  }
...
extension Data_PbExerciseIntervalledSampleList: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        switch fieldNumber {
        case 1: try decoder.decodeSingularEnumField(value: &_storage._sampleType)
        case 2: try decoder.decodeSingularUInt32Field(value: &_storage._recordingIntervalMs)
        case 3: try decoder.decodeRepeatedMessageField(value: &_storage._sampleSource)
        case 4: try decoder.decodeRepeatedUInt32Field(value: &_storage._heartRateSamples)
        case 5: try decoder.decodeRepeatedUInt32Field(value: &_storage._cadenceSamples)
        case 6: try decoder.decodeRepeatedFloatField(value: &_storage._speedSamples)
        case 7: try decoder.decodeRepeatedFloatField(value: &_storage._distanceSamples)
        case 8: try decoder.decodeRepeatedFloatField(value: &_storage._forwardAcceleration)
        case 9: try decoder.decodeRepeatedEnumField(value: &_storage._movingTypeSamples)
        case 10: try decoder.decodeRepeatedFloatField(value: &_storage._altitudeSamples)
        case 11: try decoder.decodeRepeatedMessageField(value: &_storage._altitudeCalibration)
        case 12: try decoder.decodeRepeatedFloatField(value: &_storage._temperatureSamples)
        case 13: try decoder.decodeRepeatedUInt32Field(value: &_storage._strideLengthSamples)
        case 14: try decoder.decodeRepeatedMessageField(value: &_storage._strideCalibration)
        case 15: try decoder.decodeRepeatedMessageField(value: &_storage._leftPedalPowerSamples)
        case 16: try decoder.decodeRepeatedMessageField(value: &_storage._rightPedalPowerSamples)
        case 17: try decoder.decodeRepeatedMessageField(value: &_storage._leftPowerCalibration)
        case 18: try decoder.decodeRepeatedMessageField(value: &_storage._rightPowerCalibration)
        case 19: try decoder.decodeSingularMessageField(value: &_storage._rrSamples)
        case 20: try decoder.decodeRepeatedFloatField(value: &_storage._accelerationMadSamples)
        default: break
        }
      }
    }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      if let v = _storage._sampleType {
        try visitor.visitSingularEnumField(value: v, fieldNumber: 1)
      }
      if let v = _storage._recordingIntervalMs {
        try visitor.visitSingularUInt32Field(value: v, fieldNumber: 2)
      }
...
extension Data_PbExerciseSamples: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".PbExerciseSamples"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        switch fieldNumber {
        case 1: try decoder.decodeSingularMessageField(value: &_storage._recordingInterval)
        case 2: try decoder.decodeRepeatedUInt32Field(value: &_storage._heartRateSamples)
        case 3: try decoder.decodeRepeatedMessageField(value: &_storage._heartRateOffline)
        case 4: try decoder.decodeRepeatedUInt32Field(value: &_storage._cadenceSamples)
        case 5: try decoder.decodeRepeatedMessageField(value: &_storage._cadenceOffline)
        case 6: try decoder.decodeRepeatedFloatField(value: &_storage._altitudeSamples)
        case 7: try decoder.decodeRepeatedMessageField(value: &_storage._altitudeCalibration)
        case 8: try decoder.decodeRepeatedFloatField(value: &_storage._temperatureSamples)
        case 9: try decoder.decodeRepeatedFloatField(value: &_storage._speedSamples)
        case 10: try decoder.decodeRepeatedMessageField(value: &_storage._speedOffline)
        case 11: try decoder.decodeRepeatedFloatField(value: &_storage._distanceSamples)
        case 12: try decoder.decodeRepeatedMessageField(value: &_storage._distanceOffline)
        case 13: try decoder.decodeRepeatedUInt32Field(value: &_storage._strideLengthSamples)
        case 14: try decoder.decodeRepeatedMessageField(value: &_storage._strideLengthOffline)
        case 15: try decoder.decodeRepeatedMessageField(value: &_storage._strideCalibration)
        case 16: try decoder.decodeRepeatedFloatField(value: &_storage._forwardAcceleration)
        case 17: try decoder.decodeRepeatedEnumField(value: &_storage._movingTypeSamples)
        case 18: try decoder.decodeRepeatedMessageField(value: &_storage._altitudeOffline)
        case 19: try decoder.decodeRepeatedMessageField(value: &_storage._temperatureOffline)
        case 20: try decoder.decodeRepeatedMessageField(value: &_storage._forwardAccelerationOffline)
        case 21: try decoder.decodeRepeatedMessageField(value: &_storage._movingTypeOffline)
        case 22: try decoder.decodeRepeatedMessageField(value: &_storage._leftPedalPowerSamples)
        case 23: try decoder.decodeRepeatedMessageField(value: &_storage._leftPedalPowerOffline)
        case 24: try decoder.decodeRepeatedMessageField(value: &_storage._rightPedalPowerSamples)
        case 25: try decoder.decodeRepeatedMessageField(value: &_storage._rightPedalPowerOffline)
        case 26: try decoder.decodeRepeatedMessageField(value: &_storage._leftPowerCalibration)
        case 27: try decoder.decodeRepeatedMessageField(value: &_storage._rightPowerCalibration)
        case 28: try decoder.decodeSingularMessageField(value: &_storage._rrSamples)
        case 29: try decoder.decodeRepeatedMessageField(value: &_storage._exerciseIntervalledSampleList)
        case 30: try decoder.decodeRepeatedMessageField(value: &_storage._pauseTimes)
        default: break
        }
      }
    }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      if let v = _storage._recordingInterval {
  ...
  static func ==(lhs: Data_PbExerciseSamples, rhs: Data_PbExerciseSamples) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
